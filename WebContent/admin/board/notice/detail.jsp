...
<body>
				...
				<div class="margin-top first">
					...
					<table class="table">
						<tbody>
							...
							<tr>
								<th>작성일</th>
								<td class="text-align-left text-indent" colspan="3"><%=request.getAttribute("regfate")%></td>
							</tr>
							<tr>
								<th>작성자</th>
							...
							<tr>
								<th>첨부파일</th>
								<td colspan="3">
								<!-- 아래 스파게티 코드는 파일줄을 잘라서 기입후 다운로드 가능하게하는것 -->
									<%
										String a = (String) request.getAttribute("filse");
									String b[] = null;
									if (a != null) {
										b = a.split(",");
 ...
 %>
							...
							<tr class="content">
								<td colspan="4"><%=request.getAttribute("content")%>
									<div>
										<br>
									</div>
									<div>
